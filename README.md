...
등록한 앱이 전면에 없을 때만 해당 앱의 오디오 세션을 음소거하고, 다시 전면으로 돌아오면 UnfocusMute가 직접 음소거했던 세션만 되돌립니다. UnfocusMute가 음소거하지 않았거나 사용자가 원래 음소거해 둔 세션은 복원하지 않습니다.
...
- UnfocusMute가 음소거하지 않았거나 사용자가 원래 음소거해 둔 세션은 복원하지 않습니다.
