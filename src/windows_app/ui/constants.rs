...
pub(super) const ISSUE_DIALOG_CLASS_NAME: PCWSTR = w!("UnfocusMuteIssueDialog");
...
pub(super) const ID_ISSUE_DIALOG_DETAIL: i32 = 2302;
pub(super) const ID_ISSUE_DIALOG_COPY: i32 = 2303;
pub(super) const ID_ISSUE_DIALOG_OK: i32 = 2304;
pub(super) const ID_ISSUE_DIALOG_IGNORE: i32 = 2305;
