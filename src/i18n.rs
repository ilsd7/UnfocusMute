    ...
    pub fn strings(self) -> Strings {
        match self {
            Language::Ko => Strings {
                ...
                running_process_hint: "검색 가능. PID는 현재 실행 인스턴스만 대상으로 합니다.",
            ...
            Language::En => Strings {
                ...
                running_process_hint: "Search. PID targets apply only to the current instance.",
            ...
            Language::Ja => Strings {
                ...
                running_process_hint: "検索できます。PID対象は現在のインスタンスだけです。",
            ...
            Language::ZhHans => Strings {
                ...
                running_process_hint: "可搜索。PID 目标仅适用于当前实例。",
            ...
            Language::Es => Strings {
                ...
                running_process_hint: "Busca. Los PID solo apuntan a la instancia actual.",
            ...
            Language::Fr => Strings {
                ...
                running_process_hint: "Recherche. Les PID ciblent seulement l’instance actuelle.",
            ...
            Language::Pt => Strings {
                ...
                running_process_hint: "Pesquise. PIDs valem só para a instância atual.",
            ...
            Language::Hi => Strings {
                ...
                running_process_hint: "खोजें। PID सिर्फ मौजूदा instance पर लागू है।",
            ...
            Language::Ar => Strings {
                ...
                running_process_hint: "ابحث هنا. PID للنسخة الحالية فقط.",
