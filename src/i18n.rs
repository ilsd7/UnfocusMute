    ...
    pub fn strings(self) -> Strings {
        match self {
            Language::Ko => Strings {
                ...
                running_process_hint: "게임이나 앱을 실행한 뒤 목록을 새로 고치세요.",
            ...
            Language::En => Strings {
                ...
                running_process_hint: "Start the game or app, then refresh this list.",
            ...
            Language::Ja => Strings {
                ...
                running_process_hint: "ゲームやアプリを起動してから一覧を更新します。",
            ...
            Language::ZhHans => Strings {
                ...
                running_process_hint: "先启动游戏或应用，然后刷新此列表。",
                manual_process: "进程名称",
                add_selected: "添加所选",
                add_manual: "手动添加",
