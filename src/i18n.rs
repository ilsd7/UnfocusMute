    ...
    pub fn strings(self) -> Strings {
        match self {
            Language::Ko => Strings {
                ...
                running_process_hint: "검색해서 추가할 수 있습니다. PID 항목은 재실행 후 다시 선택하세요.",
            ...
            Language::En => Strings {
                ...
                running_process_hint: "Search to add apps. Reselect PID entries after restart.",
            ...
            Language::Ja => Strings {
                ...
                running_process_hint: "検索して追加できます。PID項目は再起動後に選び直してください。",
            ...
            Language::ZhHans => Strings {
                ...
                running_process_hint: "可搜索添加。PID 项在应用重启后需要重新选择。",
            ...
            Language::Es => Strings {
                ...
                running_process_hint: "Busca para añadir. Vuelve a elegir el PID si la app se reinicia.",
            ...
            Language::Fr => Strings {
                ...
                running_process_hint: "Recherchez pour ajouter. Rechoisissez le PID après un redémarrage.",
            ...
            Language::Pt => Strings {
                ...
                running_process_hint: "Pesquise para adicionar. Escolha o PID de novo após reiniciar o app.",
            ...
            Language::Hi => Strings {
                ...
                running_process_hint: "खोजकर जोड़ें। ऐप दोबारा चलने पर PID फिर चुनें।",
            ...
            Language::Ar => Strings {
                ...
                running_process_hint: "ابحث للإضافة. اختر PID من جديد بعد إعادة تشغيل التطبيق.",
