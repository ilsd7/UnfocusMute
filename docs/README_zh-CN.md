...
如果你怀疑问题涉及安全漏洞，请不要在公开 Issue 中发布细节。请使用私密报告流程，并参阅 [SECURITY.md](../SECURITY.md) 了解详情。

## 设置文件

如果需要直接查看或备份设置文件，请点击设置界面的 `打开配置文件夹` 按钮。

文件资源管理器会打开保存设置文件的 `%APPDATA%\UnfocusMute` 文件夹。
