...
لأنه مبني كتطبيق Rust أصلي، يعمل مباشرة دون runtime منفصل. حجم الملف التنفيذي الحالي نحو 492KB، أي أقل من 1MB.
...
تتم عملية اكتشاف جلسات الصوت والتحكم في الكتم داخل جهازك عبر واجهات Windows CoreAudio. لا توجد طلبات شبكة أو telemetry أو تقارير أعطال أو تسجيل عن بُعد، ولا ينشئ UnfocusMute ملفات سجل منفصلة للتطبيق.
