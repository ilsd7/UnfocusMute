...
- ملاحظات لكل تطبيق، وحالة كتم مباشرة لكل هدف، و`إيقاف المراقبة مؤقتًا` و`استئناف المراقبة` لكل تطبيق.
- البقاء في علبة النظام، ملخص حالة في علبة النظام، إيقاف مؤقت عام، فتح مجلد الإعدادات، ومنع تشغيل نسخ متعددة.
- أيقونة GitHub صغيرة في الزاوية السفلية اليسرى تفتح صفحة المشروع في المتصفح الافتراضي. يظهر رابط المشروع عند التمرير فوقها.
...
6. انقر بزر الفأرة الأيمن على تطبيق مسجل لتعديل ملاحظته أو استخدام `إيقاف المراقبة مؤقتًا`.
7. اضغط أيقونة `GitHub` الصغيرة في الزاوية السفلية اليسرى لفتح صفحة مشروع GitHub في المتصفح الافتراضي. يظهر رابط المشروع عند التمرير فوقها.
...
UnfocusMute تطبيق محلي بالكامل. تتم كل العمليات داخل جهازك الحالي، ويعمل بشكل طبيعي حتى من دون اتصال بالإنترنت. أيقونة GitHub تفتح المتصفح الافتراضي فقط عندما تضغط عليها.
