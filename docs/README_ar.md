...
- يسجل التطبيقات من قائمة التطبيقات التي لها جلسة صوت أو عبر كتابة اسم مثل `game.exe`.
...
4. افتح قائمة `ابحث عن عملية` أو اكتب كلمة بحث، ثم اختر تطبيقًا له جلسة صوت واضغط `تسجيل`. قد لا تظهر التطبيقات التي لم تنشئ جلسة صوت بعد؛ في هذه الحالة اكتب اسم `.exe` يدويًا.
