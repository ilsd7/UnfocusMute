...
UnfocusMute تطبيق صغير وخفيف لعلبة نظام Windows يكتم تلقائيًا الألعاب والتطبيقات المحددة عندما تنتقل إلى الخلفية.

لا يقتصر على الألعاب؛ يمكنك أيضًا تسجيل تطبيقات عادية مثل المتصفحات، وتطبيقات المحادثة، والمشغلات، ومشغلات الوسائط.

<p align="center">
  <img src="../assets/screenshot_ar.png" width="760" alt="نافذة UnfocusMute الرئيسية">
</p>
...
- ملاحظات لكل تطبيق، وحالة كتم مباشرة لكل تطبيق، و`إيقاف مؤقت` و`استئناف` لكل تطبيق.
...
**ما يحفظه:** أسماء العمليات المسجلة، وPID الاختيارية، والملاحظات التي تكتبها، واللغة المختارة، وموضع النافذة، وخيارات بدء التشغيل، وحالة استعادة التطبيقات التي كتمها UnfocusMute.
