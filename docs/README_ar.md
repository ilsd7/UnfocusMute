<div align="center">
  ...
  <p><strong>تطبيق خفيف ومحمول لعلبة نظام Windows يكتم تلقائيًا الألعاب أو التطبيقات المحددة عندما تنتقل إلى الخلفية.<br>لا يستعيد إلا الجلسات التي كتمها UnfocusMute بنفسه، ويعمل محليًا بالكامل من دون اتصال بالشبكة.</strong></p>
...
**ما لا يفعله:** لا يرسل طلبات شبكة، ولا يستخدم telemetry، ولا يرسل تقارير أعطال، ولا يسجل عن بُعد، ولا يجمع البيانات. ولا يحتاج إلى صلاحيات مسؤول.
