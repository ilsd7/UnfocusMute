...
تعرض القائمة الافتراضية التطبيقات التي لديها جلسة صوت في تلك اللحظة فقط. إذا لم يكن التطبيق قد أنشأ جلسة صوت بعد، فانتقل إلى `كل العمليات` للبحث عنه بين عمليات `.exe` الجارية.
...
4. اختر تطبيقًا من `ابحث عن عملية` أو اكتب كلمة بحث للعثور عليه، ثم اضغط `تسجيل`. إذا لم يكن التطبيق قد أنشأ جلسة صوت بعد، فانتقل إلى `كل العمليات` لتصفح قائمة كل العمليات الجارية. إذا لم يكن في القائمة، فاكتب اسم `.exe` يدويًا.
