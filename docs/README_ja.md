<div align="center">
  ...
  <p><strong>選択したゲームやアプリがバックグラウンドへ移ったときに自動でミュートする、軽量でポータブルなWindowsトレイアプリです。<br>UnfocusMuteが自分でミュートしたセッションだけを復元し、ネットワーク接続なしで完全にローカルで動作します。</strong></p>
...
**行わないこと:** ネットワーク要求、テレメトリ、クラッシュレポート、リモートログ送信、データ収集は行いません。管理者権限も要求しません。
