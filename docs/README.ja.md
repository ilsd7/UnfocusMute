...
登録したアプリが前面にない間だけ、そのアプリのオーディオセッションをミュートします。アプリが前面に戻ると、UnfocusMuteが自分でミュートしたセッションだけを元に戻します。UnfocusMuteがミュートしていないセッションや、ユーザーが元からミュートしていたセッションは解除しません。
...
- UnfocusMuteがミュートしていないセッションや、ユーザーが元からミュートしていたセッションは解除しません。
